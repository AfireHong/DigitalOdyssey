...
<body class="main_body">
    <div class="layui-layout layui-layout-admin">
            ...
            <div class="layui-main mag0">
                ...
                <ul class="layui-nav top_menu">
                    ...
                    <li class="layui-nav-item" id="userInfo">
                        <a href="javascript:;"><img src="images/favicon.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName"><?php echo $_SESSION['admin'] ?></cite></a>
                        <dl class="layui-nav-child">
                            ...
                            <dd><a href="page/login/loginout.php" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
                        </dl>
                    </li>
                </ul>
            </div>
        ...
        <div class="layui-footer footer">
            <p><span>copyright @2020 数码奥德赛</span></p>
        </div>
    </div>

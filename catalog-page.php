                            ...
                            <div class="filters">
                                <div class="filter-item">
                                    ...
                                    <?php
                                        ...
                                        echo '<div class="form-check"><input class="form-check-input" type="radio" id="'.$cate['cate_id']. '" name = "cata-radio"><label class="form-check-label" for="formCheck-1">' . $cate['cate_name'] . '</label></div>';
                                    ?>
                                </div>
                            ...
                            <nav>
                                <ul class="pagination">
                                    <li class="page-item <?php if ($page == 1) {
                                                                echo "disabled";
                                                            } ?>"><a class="page-link" href="?page=1" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
                                    <li class="page-item <?php if ($page == 1) {
                                                                echo "disabled";
                                                            } ?>"><a class="page-link" href="?page=<?php echo $page - 1; ?>" aria-label="Previous"><span aria-hidden="true">‹</span></a></li>
                                    <?php
                                    $start = $page - 2;
                                    $end = $page + 2;
                                    if ($page <= 3) {
                                    ...
                                    <li class="page-item <?php if ($page == $pages) {
                                                                echo "disabled";
                                                            } ?>"><a class="page-link" href="?page=<?php echo $pages; ?>" aria-label="Next"><span aria-hidden="true">»</span></a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>

...
//从数据库拉取
$gd_info_sql = "SELECT goods.goods_name, goods.max_price, goods.description, goods.stock, img.img_url FROM goods,img WHERE goods.goods_id = '{$gd_id}' AND img.goods_id = '{$gd_id}'";
        ...
        $('#addcart').click(function() {
            ...
            layui.use('layer', function() {
                $.ajax({
                    ...
                    success: function() {
                        layer.msg("添加成功！快去<a href='shopping-cart.php'>购物车</a>看看吧！", {
                            icon: 1
                        });
                    },
                    error: function() {
